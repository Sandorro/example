                                        ...
                                        @isset($arr)
                                            @foreach($arr as $g)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="{{$g['image']}}" alt="Изображение товара" width="200">
                                                    </td>
                                                    <td>
{{--                                                        <button type="submit" class="add-cart" data-tabl="{{$g['categ']}}" data-id="{{$g['nom']}}" name="add">Добавить в корзину</button>--}}
                                                            <button type="submit" class="addToCart" data-id="{{$g['nom']}}" data-tabl="{{$g['categ']}}" name="dob">
                                                                    {{ csrf_field() }}
...
<?php //dd($catlist) ?>
                                    <p><b><u>Выберите категорию:</u></b></p>
                                    <a href="/">Все</a>
                                    <br>
...
{{--                                    </form>--}}
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{route('cartIndex')}}" class="underline text-gray-900 dark:text-white">Корзина</a></div>
                            </div>
